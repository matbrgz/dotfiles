  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${isInstalled ? 'rgba(52,211,153,0.18)' : 'var(--color-border)'}`,
        borderRadius: 8,
        padding: '14px 16px',
        display: 'flex',
    ...
    >
      ...
      {/* Description */}
      <p style={{
        fontSize: 11, color: 'var(--color-text-2)', lineHeight: 1.5, margin: 0, flexGrow: 1,
      ...
      <button
        ...
        style={{
          ...
          padding: '7px 0',
          borderRadius: 5,
          border: isInstalled ? '1px solid rgba(52,211,153,0.25)' : '1px solid var(--color-border)',
          background: isInstalled ? 'var(--color-green-bg)' : 'var(--color-surface-2)',
          color: isInstalled ? 'var(--color-green)' : isInstalling ? 'var(--color-amber)' : 'var(--color-text-2)',
          fontSize: 11,
          fontWeight: 600,
          fontFamily: 'inherit',
        ...
        onMouseEnter={e => {
          if (!isInstalling && !isInstalled) {
            ...
            btn.style.borderColor = 'var(--color-border-2)';
        ...
        onMouseLeave={e => {
          if (!isInstalling && !isInstalled) {
            ...
            btn.style.color = 'var(--color-text-2)';
          }
        }}
      >
        {isInstalling && (
          <div style={{
            ...
            border: '1.5px solid var(--color-amber)', borderTopColor: 'transparent',
